...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_sample"></a> [sample](#module\_sample) | ../../../modules/eks_manager | n/a |
## Inputs
...
| <a name="input_cluster_name"></a> [cluster\_name](#input\_cluster\_name) | EKS cluster name | `string` | `"default"` | no |
...
| <a name="input_eks_manager_k8s_name"></a> [eks\_manager\_k8s\_name](#input\_eks\_manager\_k8s\_name) | Kubernetes manager server name | `string` | `"default"` | no |
...
| <a name="input_manager_permissions"></a> [manager\_permissions](#input\_manager\_permissions) | Additional permissions for the manager. | `list(string)` | <pre>[<br>  "eks:DescribeCluster",<br>  "eks:UpdateClusterConfig",<br>  "iam:ListOpenIDConnectProviders",<br>  "iam:CreatePolicy"<br>]</pre> | no |
...
| <a name="input_user_data_file_path"></a> [user\_data\_file\_path](#input\_user\_data\_file\_path) | User data file path | `string` | `"./script/user_data.sh"` | no |
