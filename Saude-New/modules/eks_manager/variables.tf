...
variable "use_user_data" {
  description = "Must be true if user data needs to be used"
  type        = bool
  default     = false
}
...
variable "user_data_file_path" {
  ...
  type        = string
  default     = "../modules/eks_manager/script/user_data.sh"
}

variable "manager_permissions" {
  description = "Additional permissions for the manager."
  type        = list(string)
  default     = ["eks:DescribeCluster", "eks:UpdateClusterConfig", "iam:ListOpenIDConnectProviders"]
}
